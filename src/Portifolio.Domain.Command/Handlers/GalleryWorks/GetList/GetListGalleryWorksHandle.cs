...
namespace Portifolio.Domain.Command.Handlers.GalleryWorks.GetList
{
    public sealed class GetListGalleryWorksHandle : IRequestHandler<FilterGalleryWorksRequest, IEnumerable<FilterGalleryWorksResponse>>
    {
        ...
        private readonly IGenericQuery<Entities.GalleryWorks, FilterGalleryWorksRequest> _dapper;
